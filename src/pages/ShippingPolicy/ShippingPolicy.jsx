...
const ShippingPolicy = () => {
  ...
  const currentData = shippingPolicyData[language] || shippingPolicyData.en;
  ...
  return (
    <div className="legal-page-root shipping-policy-page terms-conditions-page">
      <Navbar />
            ...
            <div className="legal-layout">
              ...
              <article className="legal-content-card">
                ...
                <section className="legal-welcome-block">
                  ...
                  <p className="welcome-text">{currentData.intro}</p>
                </section>
                ...
                {currentData.sections.map((sec, index) => (
                  <div key={sec.id}>
                    <section id={sec.id} className="legal-content-section">
                      ...
                      {/* Middle Paragraph if present */}
                      {sec.middleParagraph && (
                        <p className="mt-3">{sec.middleParagraph}</p>
                      )}

                      {/* Sub Bullets */}
                      {sec.subBullets && sec.subBullets.length > 0 && (
                        <ul className="terms-bullets-list">
                          {sec.subBullets.map((sbText, sbIdx) => (
                            <li key={sbIdx}>{sbText}</li>
                          ))}
                        </ul>
                      )}
