...
const TRUST_POINTS = ["૧૦૦% શુદ્ધ", "૧૦૦% શુદ્ધતા", "સાચી પસંદગી"];
...
const HeroGujarati = () => {
  ...
  return (
    <section
      className="hero-section lang-gu"
      lang="gu"
    ...
    >
      ...
      <div className="container">
        ...
        >
          ...
          <div className="hero-btn-wrapper">
            <button className="hero-btn" onClick={handleExploreClick} type="button">
              <span>પ્રોડક્ટ્સ જુઓ</span>
              <span className="arrow-circle">→</span>
            </button>
          </div>

          <ul className="trust-row" aria-label="વિશેષતાઓ">
        ...
        >
          ...
          <img src={getImage("heroProducts")} alt="જન્મોત્રી મગફળીના તેલના ઉત્પાદનો" />
        </motion.div>
      </div>
