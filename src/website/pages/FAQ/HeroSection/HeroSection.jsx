      ...
      <Container>
        <div className="hero-text-wrap">
          ...
          <motion.h1 
            ...
            animate="visible"
          >
            {t("faqPage.heroTitle", "Frequently Asked Questions")}
          </motion.h1>
          <motion.p 
          ...
          >
            {t("faqPage.heroSubtitle", "Find answers to common questions about our purity standards, delivery procedures, and payment methods.")}
          </motion.p>
        </div>
      </Container>
    </section>
